...
Original file is located at
    https://colab.research.google.com/drive/1TrzptJvwaLNC-DUFSh1MzQj29fWP4g7p

#Building an agent with LangGraph and the Gemini API

In this notebook, I use [LangGraph](https://www.langchain.com/langgraph) to define a stateful graph-based application built on top of the Gemini API.

I will build a simulated cafe ordering system, called BaristaBot. It will provide a looping chat interface to customers where they can order cafe beverages using natural language, and you will build nodes to represent the cafe's live menu and the "back room" ordering system.
